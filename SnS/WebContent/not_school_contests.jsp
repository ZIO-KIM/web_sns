...
<html lang="ko" dir="ltr">
  <head>
    <meta charset="utf-8">
    <title>세종대학교 소프트웨어융합대학 :: 홍보 :: 교외 공모전</title>
  ...
  <body>
    ...
    <section class="content">
         ...
         %>
          ...
          %>
					<li><a
						href="not_school_contets.jsp?pageNumber=<%=startPage-1%>"
          ...
          %>
        	...
        	%>
					<li><a href="not_school_contets.jsp?pageNumber=<%=i %>"><%=i %></a></li>
					<%      			
          		}
          	%>
					<li><a class="active"
						href="not_school_contets.jsp?pageNumber=<%=pageNumber %>"><%=pageNumber %></a></li>
					<%
			...
			%>
					<li><a
						href="not_school_contets.jsp?pageNumber=<%=startPage+10 %>">다음</a></li>
					<%
				}else{
			%>
