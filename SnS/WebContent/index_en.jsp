...
<html lang="ko" dir="ltr"><!-- lastbranch test -->
  <head>
    ...
    <link rel="stylesheet" href="css/mainpage_en.css">
  ...
  <div class="container-fluid">
    ...
    <div class="navbar-header">
      ...
      <a  class="navbar-brand logobox" href='index_en.jsp'>
         <img style="width:60px; margin-left: 5px; margin-top: 10px;"src="<%=pageDAO.getPageLogo() %>" alt="소융대 로고">
      </a>
    </div>
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav" style="margin-left: -30px; margin-top: 5px;">
        <li><a href="post.jsp?boardID=1" style="font-size: 20px; color:black;">Notice</a></li>
        <li><a href="student_council_photo.jsp" style="font-size: 20px; color:black;">Gallery</a></li>
        <li class="dropdown">
          <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false" style="color:black;">Student Council<span class="caret"></span></a>
          <ul class="dropdown-menu">
            <li><a class="dropdownLi" href='student_council_introduce.jsp'>Introduce</a></li>
            <li><a class="dropdownLi" href='student_council_photo.jsp' >Gallery</a></li>
            <li><a class="dropdownLi" href='post.jsp?boardID=2'>Events</a></li>
            <li><a class="dropdownLi" href='post.jsp?boardID=3'>Public Money</a></li>
            <li><a class="dropdownLi" href='departments.jsp'>Departments</a></li>
          </ul>
        </li>
        <li class="dropdown">
          <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false" style="color:black;">Claims<span class="caret"></span></a>
          <ul class="dropdown-menu">
            <li><a class="dropdownLi" href='cmp_to_student_council.jsp'>To Student Council</a></li>
         <li><a class="dropdownLi" href='cmp_to_school.jsp'>To School</a></li>
          </ul>
        </li>
        <li class="dropdown">
          <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false" style="color:black;">Pre-students<span class="caret"></span></a>
          <ul class="dropdown-menu">
            <li><a class="dropdownLi" href='post.jsp?boardID=18'>Reviews</a></li>
         <li><a class="dropdownLi" href='post.jsp?boardID=19'>QnA</a></li>
          </ul>
        </li>
        <li class="dropdown">
          <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false" style="color:black;">Employments<span class="caret"></span></a>
          <ul class="dropdown-menu">
            <li><a class="dropdownLi" href='post.jsp?boardID=20'>Reviews</a></li>
         <li><a class="dropdownLi" href='post.jsp?boardID=21'>Interviews</a></li>
         <li><a class="dropdownLi" href='post.jsp?boardID=22'>Graduation QnAs</a></li>
          </ul>
        </li>
        <li class="dropdown">
          <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false" style="color:black;">Promotions<span class="caret"></span></a>
          <ul class="dropdown-menu">
            <li><a class="dropdownLi" href='post.jsp?boardID=24'>School</a></li>
         <li><a class="dropdownLi" href='post.jsp?boardID=25'>Not School</a></li>
          </ul>
        </li>
      ...
      <div class="im_footer_right" style="margin-left:880px; margin-top: -70px;">
         	<div class="im_footer_menu">
               <ul>
                ...
                %>
                  <li><a href="myPage.jsp">My Profile</a></li>
                  <li><a href="userLogoutAction.jsp">Logout</a></li>    
                <%
                  }
                %>
               </ul>
   ...
   <div id="modal-login" class="modal fade">
               ...
               <div class="modal-footer">
                  <div class="btn-group btn-group-justified">
                     <a
                        ...
                        class="fa fa-question-circle" aria-hidden="true"></i>Find ID/PW</a>
    ...
    <nav id='title_animation' class="title">
      ...
      <h3 id='subtitle' class="subtitle_mq">Cultivate Leaders of the Software Society</h3>
    </nav>
    
    <div><h1 id="department_board" style="font-size: 30px; font-family: 'Nanum Gothic', sans-serif;">Departments</h1></div>
    ...
    <div><h1 id="recent_board" style="font-size: 30px; font-family: 'Nanum Gothic', sans-serif;">Recent Posts</h1></div>
	...
	<section class="m_notice">
		<!-- 공지사항 -->
		<h3><a href="post.jsp?boardID=1" style="text-decoration:none;color: black;">Notice</a></h3>
 	...
 	<section class="m_notice">
		<!-- 공지사항 -->
		<h3><a href="" style="text-decoration:none;color: black;">Promotions</a></h3>
		<ul style="list-style:none;">        
		<li>
  	...
  	<section class="m_notice">
		<!-- 공지사항 -->
		<h3><a href="student_council_photo.jsp" style="text-decoration:none;color: black;">Gallery</a></h3>
		<ul style="list-style:none;">       
		<li>
  	...
  	<section class="m_notice">
		<!-- 공지사항 -->
		<h3><a href="" style="text-decoration:none;color: black;">HOT</a></h3>
		<ul style="list-style:none;">          
		<li>
   ...
   <div class="im_footerWrap">
   	<div class="im_footer" style="width: 1600px;">
         ...
         <div class="im_footer_right">
         	<div class="im_footer_menu">
               <ul>
                  <li class="active"><a href="index.jsp">Main Page</a></li><li><a href="http://www.sejong.ac.kr/">Sejong University</a></li><li><a href="http://www.sejongstudent.com/xe/">SejongStudent</a></li><li><a href="https://ko-kr.facebook.com/sejong1sc/">Software Convergence Facebook</a></li>             </ul>
            </div>
