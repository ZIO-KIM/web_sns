...
<html lang="ko" dir="ltr">
  ...
  <body>
    ...
    <nav id='gallery_all'>
      <div class="gallery">
        <a target="_blank" href="gallery_content.html"> <!-- 갤러리 콘텐츠랑 연결 -->
      ...
      <div class="gallery">
        <a target="_blank" href="gallery_content.html">
    ...
    <a class= "btn btn-default pull-right" href="Student_Council_Photo_Write.html">글쓰기</a>
