...
<html lang="ko" dir="ltr">
  <head>
    <meta charset="utf-8">
    <title>세종대학교 소프트웨어융합대학 :: 쪽지 작성 </title>
  ...
  <body>
	...
	<%
		...
		UserDTO to= userDAO.getUser(toID);
		UserDTO from= userDAO.getUser(fromID);
	%>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 id="noteModalLabel"><span class="modal-title" style="font-weight:bold;"><%=to.getUserName() %></span>에게 쪽지 쓰기</h4>
      </div>
      <form action="./note" method="post">
      <div class="modal-body">
        	<input type="hidden" class="form-control" name="fromID" value="<%=fromID %>">
        	<input type="hidden" class="form-control" name="toID" value="<%=toID %>">
      ...
      <div class="modal-footer">
        <a type="button" href="admin_user.jsp" type="button" class="btn btn-default">닫기</a>
